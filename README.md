...
　![top_page](https://gyazo.com/149ff4cccf85b67feb3ee961154c48b6/raw)
...
- トップページのマークアップ
- 商品一覧表示
- 商品詳細ページのマークアップ、バックエンド
- 商品出品ページのマークアップ
- 商品購入確認ページのマークアップ、バックエンド
- 商品の削除機能
- パンくず機能の実装
- ユーザー新規登録、ログインの本人確認情報のマークアップ、バックエンド
- クレジットカード未登録時の処理
